...
| ADR-034 | The approval gate reads the pointer, not just the width: 900px applies to a coarse pointer, a fine pointer floors at the card's own 768px content width, and an uninterrogable pointer takes the stricter floor | Ratified |
